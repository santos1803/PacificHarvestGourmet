...
$sqls = $con->prepare("SELECT id, nombre, precio, descuento FROM productos WHERE activo=1  AND categoria = 'bebidas'  ");
$sqls->execute();
...
<body>
    ...
    <main class="containerPrincipal containerPrincipal--beb">
        <article class="txt txt--beb">
            <h1>Irresistibles Bebidas</h1>
            <p>Descubre un mundo de sabor en nuestra sección de bebidas. Ofrecemos una variedad de opciones para satisfacer tu sed y tu paladar.</p>
    ...
    <main class="containerPrincipal containerPrincipal--a containerPrincipal--z">
        ...
        <article class="prueba">
            <h1>Nuestras Irresistibles Bebidas</h1>
            <p>Descubre un mundo de sabor en nuestra sección de bebidas. Ofrecemos una variedad de opciones para satisfacer tu sed y tu paladar. </p>
                ...
                <section class="trajeta">
                    ...
                    <section class="containerProductos_Cards_Txt">
                        ...
                        <article class="boton_videos boton_videos--b">
                            ...
                            <a class="hidden-btn hidden-btn--a btn btn--a" href="detallebebidas.php?id=<?php echo $row["id"]; ?>&token=<?php echo hash_hmac("sha1", $row["id"], KEY_TOKEN); ?>">Ver
                                    Mas</a>
