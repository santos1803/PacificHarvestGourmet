        ...
        <nav class="nav container">
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                    ...
                    <!--=============== login ===============-->
                    <li><a href="./login.php" class="nav__link"><svg style="fill: #1c3a6b; margin-right: 7px" xmlns="http://www.w3.org/2000/svg" height="1.2em" viewBox="0 0 448 512">
                    ...
                    <li class="dropdown__item">
                        ...
                        <ul class="dropdown__menu">
                            <li>
                                <a href="./productos.php" class="dropdown__link">
