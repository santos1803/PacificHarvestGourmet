        ...
        <nav class="nav container">
            <div class="nav__data">
                ...
                <div class="nav__toggle nav__toggless" id="nav-toggle">
                    <a href="./agregarcarrito_english.php">
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                    <li><a href="./index_english.php" class="nav__link"><svg style="fill: #1c3a6b; margin-right: 7px"
                    ...
                    <li class="dropdown__item">
                        ...
                        <ul class="dropdown__menu">
                            <li>
                                <a href="./productos_english.php" class="dropdown__link">
                    ...
                    <li><a href="./envios_english.php" class="nav__link"><svg style="fill: #1c3a6b; margin-right: 7px"
                        ...
                        <ul class="dropdown__menu">
                            ...
                            <li>
                                <a href="./index_english.php" class="dropdown__link">
                                    <img class="flag_language" src="./recursos/estados-unidos.png" alt="">
                                    English
                                </a>
                            </li>
                    ...
                    <li><a href="./contactos_english.php" class="nav__link"><svg
                                style="fill: #1c3a6b; margin-right: 7px" xmlns="http://www.w3.org/2000/svg"
                                height="1.2em" viewBox="0 0 512 512">
                                <path
