...
<body>
    ...
    <div class="zone__time">
        <section class="time__shipping">
            <article class="options__title">
                <h2>CONTACT US</h2>
                <p>If you have any questions regarding our shipping policy, you can contact us by email at <a href="mailto:gnavarro@pacificharvestgourmet.com">info@pacificharvestgourmet.com</a></p>
            </article>
        </section>
