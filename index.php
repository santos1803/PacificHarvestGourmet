...
<body>
    ...
    <header class="header">
        <nav class="nav container">
            <div class="nav__data">
                ...
                <div class="nav__toggle nav__toggless" id="nav-toggle">
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                    <li><a href="./index.php" class="nav__link"><svg style="fill: #1c3a6b; margin-right: 7px"
                                xmlns="http://www.w3.org/2000/svg" height="1.2em" viewBox="0 0 576 512">
                                <path
                    ...
                    <li>
                        ...
                        <li class="dropdown__item">
                            <div class="nav__link">
                                <svg style="fill: #1c3a6b; margin-right: 7px" xmlns="http://www.w3.org/2000/svg"
                                    height="1.2em" viewBox="0 0 448 512">
                                    <path
                    ...
                    <?php } else { ?>
                        <a href="./login.php" class="nav__link"><svg style="fill: #1c3a6b; margin-right: 7px"
                        ...
                        <ul class="dropdown__menu">
                            ...
                            <li>
                                <a href="./alimentos.php" class="dropdown__link">
                                    <svg style="fill: #1c3a6b;" xmlns="http://www.w3.org/2000/svg" height="1.2em"
                                        viewBox="0 0 512 512">
                                        <path
                    ...
                    <li><a href="./envios.php" class="nav__link"><svg style="fill: #1c3a6b; margin-right: 7px"
                                xmlns="http://www.w3.org/2000/svg" height="1.2em" viewBox="0 0 640 512">
                                <path
                    ...
                    <li><a href="./contactos.php" class="nav__link"><svg style="fill: #1c3a6b; margin-right: 7px"
                                xmlns="http://www.w3.org/2000/svg" height="1.2em" viewBox="0 0 512 512">
                                <path
    ...
    <div class="containerCuatro">
        ...
        <section class="textoExclusivo">
            ...
            <article class="articleParrafo">
                <p>La marca se ha ganado una reputación destacada por su compromiso con la sostenibilidad y la pesca
                    responsable. Pacific Harvest trabaja en estrecha colaboración con pescadores locales y utiliza
                    métodos de pesca selectivos.</p>
            </article>
    ...
    <div class="containerPrincipal containerCinco">
        <article class="txt txt2">
            <h1>Llegamos a ti</h1>
            <p>El shipping puede ser realizado por diferentes medios de transporte, como barcos, aviones, camiones o
