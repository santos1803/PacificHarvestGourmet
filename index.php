    ...
    <header>
        ...
        <nav class="nav_responsive">
            ...
            <div class="nav__container">
                ...
                <a href="#" class="nav__menu nav__menu--second" onclick="mostrar();">
                ...
                <a href="./agregarcarrito.php" class="nav__cart">
                    <svg style="fill: #1c3a6b;" xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 576 512">
                ...
                <ul class="dropdown" id="menu">
                    ...
                    <li class="dropdown__list">
                        <a href="#" class="dropdown__link">
                            ...
                            <span class="dropdown__span"><?php echo $_SESSION['user_name']; ?></span>
                        ...
                        <div class="dropdown__content">
                            ...
                            <ul class="dropdown__sub">
                                ...
                                <li class="dropdown__li">
                                    <a href="./compras.php" class="dropdown__anchor">Mis Compras</a>
                                </li>
                                <li class="dropdown__li">
                                    <a href="./logout.php" class="dropdown__anchor">Cerrar Sesion</a>
                                </li>
            ...
            <div class="nav__container_desktop">
                ...
                <section class="items_nav">
                    <ul class="cont_ul">
                        ...
                        <a href="./login.php">
                            <?php if (isset($_SESSION['user_id'])) { ?>
                                <li class="dropdown_menu"> <?php echo $_SESSION['user_name']; ?>
                                    <ul class="ul_second">
                                        <a href="./compras.php">
                                            <li>Mis Compras</li>
                                        </a>
                        ...
                        <li class="dropdown_menu">Productos
                            <ul class="ul_second">
                                <a href="./producto.php">
                                    <li>General</li>
                                </a>
                        ...
                        <li class="dropdown_menu dropdown_language">Lenguaje
                        ...
                        <a class="carrito" href="./agregarcarrito.php">
                            <li><svg style="fill: #1c3a6b;" xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 576 512">
                                    <path d="M24 0C10.7 0 0 10.7 0 24S10.7 48 24 48H69.5c3.8 0 7.1 2.7 7.9 6.5l51.6 271c6.5 34 36.2 58.5 70.7 58.5H488c13.3 0 24-10.7 24-24s-10.7-24-24-24H199.7c-11.5 0-21.4-8.2-23.6-19.5L170.7 288H459.2c32.6 0 61.1-21.8 69.5-53.3l41-152.3C576.6 57 557.4 32 531.1 32H360V134.1l23-23c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9l-64 64c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l23 23V32H120.1C111 12.8 91.6 0 69.5 0H24zM176 512a48 48 0 1 0 0-96 48 48 0 1 0 0 96zm336-48a48 48 0 1 0 -96 0 48 48 0 1 0 96 0z" />
                                </svg></li>
                            <?php if ($num_cart > 0) { ?>
