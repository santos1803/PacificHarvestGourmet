...
$sqlss = $con->prepare("SELECT id, name, precio, descuento FROM productos WHERE activo=1  AND categorie = 'seafood'  ");
$sqlss->execute();
...
<body>
    ...
    <main class="containerPrincipal containerPrincipal--mar">
        <article class="txt txt--mar">
            <h1>Sea Delights</h1>
            <p>We have gathered a wide variety of canned and delicious ocean products for you to enjoy in the comfort of your home. </p>

        </article>

    </main>

    <main class="containerPrincipal containerPrincipal--a containerPrincipal--i">
