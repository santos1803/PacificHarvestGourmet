...
<body>
    ...
    <div class="zone__time">
        <section class="time__shipping">
            <article class="options__title">
                <h2>CONTÁCTANOS</h2>
                <p>Si tienes alguna pregunta sobre nuestra política de envío, puedes contactarnos por correo electrónico a <a href="mailto:gnavarro@pacificharvestgourmet.com">info@pacificharvestgourmet.com</a></p>
            </article>
        </section>
