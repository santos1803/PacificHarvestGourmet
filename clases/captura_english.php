...
//En este documento hacemos las configuraciones y validaciones necesarias para poder capturar los datos de la compras realizadas por paypal y posteriormente ingresar los datos en la tabla de compra
...
if (is_array($datos)) {
    ...
    if($id > 0) {
        ...
        if($productos != null) {
            ...
            $asunto = 'Details of your purchase';
            $cuerpo = '<h4> Thank you for your purchase<h4>';
            $cuerpo .= '<p>The ID of your purchase is <b>' . $id_transaccion . '</b></p>' ;
            $mailer = new Mailer();
