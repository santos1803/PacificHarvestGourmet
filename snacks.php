...
<body>
    ...
    <main class="containerPrincipal containerPrincipal--reg">
        <article class="txt txt--reg">
            <h1> Explora Nuestros Sabrosos Snacks</h1>
            <p>Te invitamos a explorar un mundo de sabores y texturas que satisfarán tus antojos en cualquier momento del día.</p>
