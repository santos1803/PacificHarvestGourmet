...
$sqls = $con->prepare("SELECT id, nombre, precio, descuento FROM productos WHERE activo=1  AND categorie = 'drinks'  ");
$sqls->execute();
                ...
                <section class="trajeta">
                    ...
                    <section class="containerProductos_Cards_Txt">
                        ...
                        <article class="boton_videos boton_videos--b">
                            ...
                            <a class="hidden-btn hidden-btn--a btn btn--a" href="detallebebidas_english.php?id=<?php echo $row["id"]; ?>&token=<?php echo hash_hmac("sha1", $row["id"], KEY_TOKEN); ?>">View
                                    More</a>
